...
const Detail = ({ properties }) => {
  ...
  useEffect(() => {
    const filter = properties.find((property) => property.id === id);
    setDetail(filter);
    console.log(filter);
  }, [id, properties]);
  ...
  const daysOnHously = Math.floor(
    (new Date() - new Date(detail?.listing_date)) / (1000 * 60 * 60 * 24),
  );
  //console.log(new Date());
  //console.log(daysOnHously);

  const pricePerSqft = detail?.price / detail?.square_footage;
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex justify-between items-center mt-4">
                        <span className="text-xl font-medium dark:text-white">
                          £{detail?.price?.toLocaleString("en-GB")}
                        </span>
                      ...
                      <ul className="list-none mt-4">
                        ...
                        <li className="flex justify-between items-center mt-2">
                          ...
                          <span className="font-medium text-sm dark:text-white">
                            £{simpleEstimate.toLocaleString("en-GB")}/month
                          </span>
                        </li>
                      </ul>
                    </div>
